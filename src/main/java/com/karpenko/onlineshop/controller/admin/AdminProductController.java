...
public class AdminProductController {
    ...
    public String listProducts(Model model) {
        model.addAttribute("products", productService.findProducts(null, null, org.springframework.data.domain.PageRequest.of(0, 100)).getContent());
    ...
    public String saveProduct(@ModelAttribute Product product,
        ...
        try {
            ...
            log.error("Fehler beim Speichern des Produkts", e);
    ...
    public String showEditForm(@PathVariable Long id, Model model) {
        ...
        Product entity = categoryRepository.findById(1L).map(c -> new Product()).orElse(new Product()); // Placeholder, in Realität: productRepository.findById(id)
        return "admin/products/form";
    }
